...
describe('Packager', function() {
  ...
  it('should download seed project', function(done) {
    this.timeout(30000);
    var packageTestUrl = urlJoin(baseUrl, '/package/native-mobile-samples/master?path=Android/basic-sample&type=replace&filePath=Android/basic-sample/app/src/main/res/values/auth0.xml');
