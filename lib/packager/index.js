...
if (nconf.get('PACKAGER_URL')) {
  ...
  const urlFormat = '/:repo/:branch/create-package';
  router.use(urlFormat, overrideIfAuthenticated);
  router.use(urlFormat, function (req, res, next) {
  ...
  router.get(urlFormat, function(req, res) {
