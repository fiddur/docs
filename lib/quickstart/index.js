...
function middleware(req, res, next) {
  ...
  res.locals.quickstart.apptypes = prepareData({}, collections.apptypes);
  res.locals.quickstart.clientPlatforms = prepareData({}, collections.clientPlatforms);
  res.locals.quickstart.nativePlatforms = prepareData({}, collections.nativePlatforms);
  res.locals.quickstart.hybridPlatforms = prepareData({}, collections.hybridPlatforms);
  res.locals.quickstart.serverPlatforms = prepareData({}, collections.serverPlatforms);
  res.locals.quickstart.serverApis = prepareData({}, collections.serverApis);
  next();
}
