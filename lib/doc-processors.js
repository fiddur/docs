...
var lodashProcessor = function(context, text) {
  return (context.meta && context.meta.lodash) ? lodash.template(text)(context) : text;
};
 ...
 * @api public
 */
var markdown = function(context, text) {
  return marked(text, { renderer: renderer });
};

var jsProcessor = require('markdocs').Processors.js;

module.exports.mdProcessor = markdown;
module.exports.jsProcessor = jsProcessor;
module.exports.processors = [jsProcessor, lodashProcessor, markdown, mediaPath, relativePath];
