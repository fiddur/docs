...
router.get('/quickstart', json.bind(json, {
  app_types: prepareData({}, quickstartCollections.appTypes),
  native_platforms: prepareData({}, quickstartCollections.nativePlatforms),
  web_platforms: prepareData({}, quickstartCollections.webPlatforms),
  service_platforms: prepareData({}, quickstartCollections.servicePlatforms),
}));
