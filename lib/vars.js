...
export default Object.assign(vars, {
  account: {
    ...
    guardianNamespace: '__AUTH0_GUARDIAN_NAMESPACE__',
  ...
  env: {
    ...
    DOMAIN_URL_SUPPORT: nconf.get('DOMAIN_URL_SUPPORT'),
    GUARDIAN_DOMAIN_URL: nconf.get('GUARDIAN_DOMAIN_URL'),
    ...
    DOMAIN_URL_CDN: nconf.get('DOMAIN_URL_CDN')
  },
